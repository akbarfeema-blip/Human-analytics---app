...
""")
        ...
        if st.button("Show Quick Tips"):
            with st.expander("Practical Tips for Improvement"):
                st.write("- Practice short answers focusing on one key point at a time.")
                st.write("- Record yourself to check eye contact and posture.")
                st.write("- Reduce filler words by pausing silently instead.")
                st.write("- Highlight key points with controlled hand gestures.")
